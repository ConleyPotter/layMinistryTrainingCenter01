...
if($_POST)
{
    ...
    $your_email = "ron.serpliss@layministry-trainingcenter.com";
...
//    $mail->Host       = 'smtp.layministry-trainingcenter.com';                    // Set the SMTP server to send through
//    $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
//    $mail->Username   = 'ron.serpliss@layministry-trainingcenter.com';                     // SMTP username
//    $mail->Password   = '+4bds|a"{K&6j';                         // SMTP password
